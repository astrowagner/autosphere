;This routine automatically finds sources above a particular SNR sigma in an ADI-type dataset. i.e. applicable when the noie profile is more uniform when accounted for at a particular radius away from the center than among the frame as a whole. 
...
minvalue=minvalue,maxvalue=maxvalue,no_2d=no_2d,no_smooth=no_smooth
...
cgps_open,location+name+'_source_map.ps'
